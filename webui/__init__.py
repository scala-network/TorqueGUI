...
class BaseWebUI(QMainWindow):
    def __init__(self, html, app, hub, window_size, debug=False):
        ...
        self.icon = self._getQIcon('stellite_icon_64.png')
...
#         self.view.load(qt_core.QUrl(self.url))
    ...
    def about(self):
        QMessageBox.about(self, "About", \
            u"%s <br><br>Copyright© 2017 - Sumokoin Projects (www.sumokoin.org) <br> Copyright© 2018 - Stellite (www.stellite.cash)" % self.agent)
