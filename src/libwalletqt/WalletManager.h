...
public:
    enum LogLevel {
        LogLevel_Silent = Torque::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Torque::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Torque::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Torque::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Torque::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Torque::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Torque::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Torque::WalletManagerFactory::LogLevel_Max,
    };
