...
public:
    enum Direction {
        Direction_In  =  Torque::TransactionInfo::Direction_In,
        Direction_Out =  Torque::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Torque::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Torque::TransactionInfo * m_pimpl;
