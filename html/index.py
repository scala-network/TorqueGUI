    ...
    <body>
            ...
            <div class="tab-content" style="height:490px; margin-top:20px;">
                ...
                <div id="balance_tab" class="tab-pane fade in active">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-xs-6">
                                <h5><font color="#7646e3"><i class="fa fa-fw fa-balance-scale" style="color:#7646e3;"></i> Balance:</font></h5>
        ...
        <script id="recent_tx_row_templ" type="x-tmpl-mustache">
            <div class="col-sm-12">
                <div class="col-xs-10" style="padding-right:0">
                    <p class="tx-list tx-{{cls_in_out}}"><i class="fa fa-{{ tx_fa_icon }}"></i> ({{tx_direction}}) <span class="tx-list txid"><a href="javascript:open_link('https://explorer.stellite.cash/tx/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span></p>
        ...
        <script id="tx_detail_templ" type="x-tmpl-mustache">
            <p class="tx-list tx-{{cls_in_out}}" style="font-size: 90%"><i class="fa fa-{{ tx_fa_icon }}"></i> {{tx_direction}}<br>
                <span class="tx-list txid"><a href="javascript:open_link('https://explorer.stellite.cash/tx/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span>
            </p>
